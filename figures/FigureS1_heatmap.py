...
# Read reference data 
fe           = nc.Dataset(f'{dir_ERA5}heatmap_stats_{hw_intsc}_{hw_lengthc}_{drght_indxc1}_{drght_intsc}_drought_{drght_durc}_ERA5.1deg.nc')
...
fspei = nc.Dataset(f'{dir_ERA5}heatmap_stats_{hw_intsc}_{hw_lengthc}_{drght_indxc2}_{drght_intsc}_drought_{drght_durc}_ERA5.1deg.nc')
...
plt.savefig('FigureS1_heatmap.pdf')
