...
f_tp_1deg=... ## absolute path to 1degree ERA5 precipitation file
f_pet_1deg=... ## absolute path to 1degree ERA5 potential evaporation file (computed in ERA5_process_pet.m)

outbase=ERA5_CONUS_1deg_monthly_198101_202012 ## output file will be saved as [outbase]_spei_##
