...
addpath('...'); %% add path to ERA5_set_paths.m
ERA5_set_paths;

%% Filename for time, lat, lon
time_lat_lon_file = strcat(to_tp,'ERA5_tp_CONUS_monthly_198101_202012_1deg.nc');

%% Input Filenames
input_filename=cell(1,2);

input_filename{1} = strcat(to_spi,'ERA5_CONUS_1deg_monthly_198101_202012_spi_gamma_06.nc');
input_filename{2} = strcat(to_spei,'ERA5_CONUS_1deg_monthly_198101_202012_spei_gamma_06.nc');
...
output_filename{1} = strcat(to_spi,'ERA5_CONUS_monthly_198101_202012_spi_06_drought_metrics_numbered.nc');
output_filename{2} = strcat(to_spei,'ERA5_CONUS_monthly_198101_202012_spei_06_drought_metrics_numbered.nc');
...
%% Start For Loop to run the SPI/SPEI files through the scripts
